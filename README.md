...
A site that shows which produce that's in season for your area, and fetches relevant recipes using these ingredients. A one day hackathon project which I intend to develop further.
